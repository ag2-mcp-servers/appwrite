...
This project is an MCP (Multi-Agent Conversation Protocol) Server for the given OpenAPI URL - https://api.apis.guru/v2/specs/appwrite.io/server/0.9.3/openapi.json, auto-generated using AG2's [MCP builder](https://mcp.ag2.ai).
